...
const materials = [
  ...
  new THREE.MeshStandardMaterial({ 
    roughness: 0.7,
    metalness: 0.0,
    color: 0xf4a460 // Base color for cereal
  }) // bottom material (will be updated with texture)
];

// Loading the cereal texture after materials are defined
const cerealTexture = textureLoader.load('/textures/cereal_texture.jpg', function(texture) {
  console.log('Cereal texture loaded successfully');
...
// Adding text to indicate that the bottom part is cereal
const infoElement = document.getElementById('info');
infoElement.innerHTML = `
  <h1>Real Earth 3D Visualization</h1>
  <p>Click and drag to move the planet model</p>
  <p><strong>Top layer:</strong> Earth Map | <strong>Bottom layer:</strong> Cereal!</p>
`;
